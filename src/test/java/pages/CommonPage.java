...
public class CommonPage {
    ...
    public void verifyDataTable(String appNameInput, String sessionInput, String userBaseInput, boolean status) {
        boolean check = false;
...
//    }
//    // scroll up
//    public void getScrollUp() throws InterruptedException {
//        Thread.sleep(1000);
//        ((JavascriptExecutor) TestRunner.driver).executeScript("arguments[0].scrollIntoView(true);", topButton);
//    }
...
//    }
    ...
    public boolean verifyDataTable(String firstName, String lastName, String role, String userName, String password) {
        List<WebElement> rows = accountTable.findElements(By.tagName("tr"));
        boolean check=false;
        for (int i = 1; i < rows.size(); i++) {
            List<WebElement> cols = rows.get(i).findElements(By.tagName("td"));
